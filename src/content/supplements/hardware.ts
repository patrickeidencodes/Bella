...
const supplement: { flashcards: RawFlashcard[]; questions: RawQuestion[] } = {
  flashcards: [
    { front: "Was ist Hardware?", back: "Hardware ist alles, was man anfassen kann, z.B. Bildschirm, Tastatur und Gehaeuse." },
    { front: "Was ist Software?", back: "Software sind die Programme, die man nicht anfassen kann." },
    { front: "Was beschreibt das EVA-Prinzip?", back: "EVA steht fuer Eingabe - Verarbeitung - Ausgabe." },
    { front: "Was ist die CPU und welche Aufgabe hat sie?", back: "Die CPU (Prozessor) ist das Gehirn des Computers und arbeitet Befehle Schritt fuer Schritt ab." },
    ...
    { front: "Was sind Peripheriegeraete? Nenne Beispiele.", back: "Peripheriegeraete sind Eingabegeraete (Maus, Tastatur, Scanner) und Ausgabegeraete (Monitor, Drucker)." },
    { front: "Was ist Dual-Channel beim Arbeitsspeicher?", back: "Beim Dual-Channel nutzt der Arbeitsspeicher zwei Kanaele gleichzeitig und wird dadurch schneller." },
  ],
  questions: [
    {
      type: "mc",
      ...
      correct: [1],
      explanation: "Hardware ist alles, was man anfassen kann, wie Bildschirm, Tastatur und Gehaeuse. Software hingegen sind die Programme.",
      difficulty: 1,
    },
    {
      type: "mc",
      prompt: "Wofuer steht die Abkuerzung EVA?",
      options: [
        "Einheit - Verfahren - Ausfuehrung",
        "Elektronik - Verarbeitung - Anzeige",
        "Eingabe - Verarbeitung - Ausgabe",
        "Erfassung - Verwaltung - Ablage"
      ],
      correct: [2],
      explanation: "EVA steht fuer Eingabe - Verarbeitung - Ausgabe und beschreibt den grundlegenden Ablauf der Datenverarbeitung.",
      difficulty: 1,
    },
    {
      type: "mc",
      ...
      options: [
        "Netzteil, Luefter und Kuehlkoerper",
        "Rechenwerk, Steuerwerk und Register",
        "RAM, ROM und Cache",
        "Mainboard, Grafikkarte und Soundkarte"
      ],
      correct: [1],
      explanation: "Die CPU besteht aus Rechenwerk, Steuerwerk und Registern. Sie ist das Gehirn des Computers und verarbeitet Befehle Schritt fuer Schritt.",
      difficulty: 2,
    },
    {
      type: "mc",
      ...
      correct: [3],
      explanation: "Der RAM ist ein kurzfristiger Speicher. Beim Ausschalten des Computers werden alle darin enthaltenen Daten geloescht.",
      difficulty: 1,
    },
    {
      type: "truefalse",
      ...
      options: ["Wahr", "Falsch"],
      correct: [0],
      explanation: "Das stimmt. Die SSD hat keine beweglichen Teile, was sie robuster und schneller als eine herkoemmliche HDD macht. Beide speichern Daten dauerhaft.",
      difficulty: 1,
    },
    {
      type: "mc",
      ...
      options: [
        ...
        "Ein Eingabegeraet zur Dateneingabe"
      ],
      correct: [2],
    ...
    {
      type: "mc",
      prompt: "Welches der folgenden Geraete ist ein Eingabegeraet?",
      options: [
        "Monitor",
        "Drucker",
        "Lautsprecher",
      ...
      correct: [3],
      explanation: "Der Scanner ist ein Eingabegeraet. Monitor, Drucker und Lautsprecher sind Ausgabegeraete.",
      difficulty: 1,
    },
    {
      type: "mc",
      ...
      options: [
        "Der RAM wird gekuehlt und verbraucht weniger Strom",
        "Zwei RAM-Module sichern sich gegenseitig ab",
        "Der Arbeitsspeicher nutzt zwei Kanaele gleichzeitig und wird dadurch schneller",
        "Der RAM wird auf zwei Festplatten gespiegelt"
      ],
      correct: [2],
      explanation: "Dual-Channel bedeutet, dass der Arbeitsspeicher zwei Datenkanaele gleichzeitig nutzt. Das erhoht die Datenuebertragungsrate und macht das System schneller.",
      difficulty: 2,
    },
    {
      type: "truefalse",
    ...
    },
    {
      ...
      options: [
        ...
        "Sie ist das Gehirn des Computers und arbeitet Befehle Schritt fuer Schritt ab",

...
const supplement: { flashcards: RawFlashcard[]; questions: RawQuestion[] } = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: ["Ausgabe", "Gewinn", "Erloes", "Ertrag"],
      correct: [0],
    ...
    },
    {
      ...
      correct: [3],
      explanation: "Das Gegenteil von 'Angebot' ist 'Nachfrage'. Im wirtschaftlichen Kontext stehen Angebot (was Anbieter bereitstellen) und Nachfrage (was Kaeufer wuenschen) einander gegenueber.",
      difficulty: 1,
    },
    {
      type: "mc",
    ...
    },
    {
      ...
      options: ["verpflichtend", "optional", "offen", "moeglich"],
      correct: [0],
